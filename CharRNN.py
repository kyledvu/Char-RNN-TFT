...
def train():
    ...
    save_path = "./preTrained/CharRNN_TFT.pth"
    ...
    for i_epoch in range(1, epochs+1):
        ...
        while data_ptr + batch_size * seq_len + 1 <= data_size:
            input_seq = []
            target_seq = []
            for b in range(batch_size):
                start_index = data_ptr + b * seq_len
                input_seq.append(data[start_index : start_index + seq_len])
                target_seq.append(data[start_index + 1 : start_index + seq_len + 1])
            ...
            if data_ptr + batch_size * seq_len + 1 > data_size:
                break
        ...
        input_seq = data[rand_index : rand_index+1].unsqueeze(1)
